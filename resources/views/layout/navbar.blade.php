  ...
  <body>
    ...
    <img src="img/logo.png" alt="" width="120" height="80" class="pt-2">
      ...
      <ul class="nav text-center">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('informasi') }}" style="font-size: 18px; color: black; font-family: 'Times New Roman', Times, serif;">Informasi</a></li>

        @if (auth()->user()->level == "admin")
        <li class="nav-item"><a class="nav-link" href="{{ route('kelolaproduk.index') }}" style="font-size: 18px; color: black; font-family: 'Times New Roman', Times, serif;">Kelola Produk</a></li>
        @endif
        <li class="nav-item"><a class="nav-link" href="{{ route('logout') }}" style="font-size: 18px; color: black; font-family: 'Times New Roman', Times, serif;">Logout</a></li>
